...
public class YuletideTreasureWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(YuletideTreasureWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/YuletideTreasureWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/YuletideTreasureWLAIW/InitOutcome.xml").getDocumentElement();
